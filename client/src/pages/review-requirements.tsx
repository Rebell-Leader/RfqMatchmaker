            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* Price (exists in both standard and AI hardware RFQs) */}
                  <div>
                    ...
                    <p className="font-medium">Weighted at {requirements.criteria.price?.weight || 0}%</p>
                  </div>
                  
                  {/* Standard RFQ Quality */}
                  {requirements.criteria.quality && (
                    <div>
                      <div className="flex items-center mb-1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="font-medium">Weighted at {requirements.criteria.quality.weight}% (specifications, reliability)</p>
                    </div>
                  )}
                  
                  {/* Standard RFQ Delivery */}
                  {requirements.criteria.delivery && (
                    <div>
                      <div className="flex items-center mb-1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  {/* AI Hardware RFQ Performance */}
                  {requirements.criteria.performance && (
                    <div>
                      <div className="flex items-center mb-1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="font-medium">
                        Weighted at {requirements.criteria.performance.weight}% 
                        (compute speed, memory bandwidth)
                      </p>
                    </div>
                  )}
                  
                  {/* AI Hardware RFQ Availability */}
                  {requirements.criteria.availability && (
                    <div>
                      <div className="flex items-center mb-1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="font-medium">
                        Weighted at {requirements.criteria.availability.weight}% 
                        (in-stock, lead time)
                      </p>
                    </div>
                  )}
                  
                  {/* AI Hardware RFQ Compliance */}
                  {requirements.criteria.compliance && (
                    <div>
                      <div className="flex items-center mb-1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="font-medium">
                        Weighted at {requirements.criteria.compliance.weight}% 
                        (export controls, certifications)
                      </p>
                    </div>
                  )}
                  
                  {/* AI Hardware RFQ Support */}
                  {requirements.criteria.support && (
                    <div>
                      <div className="flex items-center mb-1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="font-medium">
                        Weighted at {requirements.criteria.support.weight}% 
